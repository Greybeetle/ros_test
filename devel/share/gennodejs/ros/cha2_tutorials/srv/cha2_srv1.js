...
class cha2_srv1Request {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cha2_srv1Request
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cha2_srv1Request
    let len;
    let data = new cha2_srv1Request(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new cha2_srv1Request(null);
    if (msg.A !== undefined) {
      resolved.A = msg.A;
    }
    else {
...
class cha2_srv1Response {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cha2_srv1Response
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cha2_srv1Response
    let len;
    let data = new cha2_srv1Response(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cha2_tutorials/cha2_srv1Response';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cha2_srv1Response(null);
...
module.exports = {
  Request: cha2_srv1Request,
  Response: cha2_srv1Response,
  md5sum() { return '2a5c7a37218262bae4fcfaa1007692aa'; },
  datatype() { return 'cha2_tutorials/cha2_srv1'; }
};
